            ...
            <ul class="getting-started">
                ...
                <li>
                    ...
                    <div>
                        ...
                        <p>
                            Run <span class="boxy">sails lift</span> to start up your app server.  If you visit <a href="http://localhost:443/user"><span class="boxy">http://localhost:443/user</span></a> in your browser, you'll see a socket.io-compatible REST API was generated for your 'User' model.
                        </p>
                    </div>
                </li>
                <li>
